...
public final class ShareCompat {
    ...
    public static String getCallingPackage(Activity activity) {
        ...
        return callingPackage == null ? f.a(activity.getIntent(), EXTRA_CALLING_PACKAGE) : callingPackage;
    }
    ...
    public static class IntentReader {
        ...
        public String getHtmlText() {
            String a = f.a(this.mIntent, IntentCompat.EXTRA_HTML_TEXT);
            if (a == null) {
        ...
        public String getSubject() {
            return f.a(this.mIntent, "android.intent.extra.SUBJECT");
        }
