...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void enqueueAction(android.support.v4.app.FragmentManagerImpl.OpGenerator r2, boolean r3) {
        /*
            r1 = this;
            if (r3 != 0) goto L5
            r1.checkStateLoss()
            ...
            if (this.mBackStack != null && (size = this.mBackStack.size()) > 0) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ...
                    if (DEBUG) {
                        ...
                        sb3.append(i3);
                        sb3.append(": ");
                        sb3.append(this.mBackStack.get(i3));
                    }
                }
            }
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            for (int i6 = 0; i6 < fragmentManagerState.mBackStack.length; i6++) {
                ...
                if (DEBUG) {
                    ...
                    sb4.append(i6);
                    sb4.append(" (index ");
                    sb4.append(instantiate2.mIndex);
                    sb4.append("): ");
    ...
    public final View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if ("fragment".equals(str)) {
            String attributeValue = attributeSet.getAttributeValue(null, CommonConstant.File.CLASS);
