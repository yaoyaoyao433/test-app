...
public final class NotificationManagerCompat {
    ...
    public static Set<String> getEnabledListenerPackages(Context context) {
        Set<String> set;
        String a = l.a(context.getContentResolver(), SETTING_ENABLED_NOTIFICATION_LISTENERS);
        synchronized (sEnabledNotificationListenersLock) {
            if (a != null) {
                try {
                    if (!a.equals(sEnabledNotificationListeners)) {
                        String[] split = a.split(CommonConstant.Symbol.COLON);
                        ...
                        sEnabledNotificationListeners = a;
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public static class NotifyTask implements Task {
        ...
        public String toString() {
            return "NotifyTask[packageName:" + this.packageName + ", id:" + this.id + ", tag:" + this.tag + CommonConstant.Symbol.MIDDLE_BRACKET_RIGHT;
        }
    }
    ...
    public static class CancelTask implements Task {
        ...
        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.id + ", tag:" + this.tag + ", all:" + this.all + CommonConstant.Symbol.MIDDLE_BRACKET_RIGHT;
        }
    }
}
