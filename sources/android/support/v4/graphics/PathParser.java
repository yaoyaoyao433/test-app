...
public class PathParser {
    ...
    private static float[] getFloats(String str) {
        ...
        try {
            ...
            throw new RuntimeException("error in parsing \"" + str + CommonConstant.Symbol.DOUBLE_QUOTES, e);
        }
    }
    ...
    public static class PathDataNode {
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            while (true) {
                ...
                double d8 = f11;
                double d9 = (((-f8) * sin) + (d5 * cos)) / d8;
                float f12 = f10;
                float f13 = f11;
                double d10 = f4;
                double d11 = ((f9 * cos) + (d10 * sin)) / d6;
                double d12 = (((-f9) * sin) + (d10 * cos)) / d8;
                double d13 = d7 - d11;
                double d14 = d9 - d12;
                ...
                if (d18 < 0.0d) {
                    new StringBuilder("Points are too far apart ").append(d17);
        ...
        private static void arcToBezier(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            ...
            while (i < ceil) {
                ...
                path.cubicTo((float) (d21 + (d20 * sin4)), (float) (d18 + (d19 * sin4)), (float) (d25 - (sin4 * d27)), (float) (d26 - (sin4 * d28)), (float) d25, (float) d26);
                i++;
                d18 = d26;
                d21 = d25;
                d22 = d23;
