...
public final class MultiDex {
    ...
    public static void install(Context context) {
        ...
        if (Build.VERSION.SDK_INT < 4) {
            throw new RuntimeException("Multi dex installation failed. SDK " + Build.VERSION.SDK_INT + " is unsupported. Min SDK version is 4" + CommonConstant.Symbol.DOT);
        }
        try {
            ...
            synchronized (installedApk) {
                ...
                if (Build.VERSION.SDK_INT > 20) {
                    ...
                    sb.append(": SDK version higher than 20");
                    sb.append(" should be backed by runtime with built-in multidex capabilty but it's not the ");
