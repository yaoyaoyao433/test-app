...
public final class HttpUrl {
        ...
        final Builder parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (schemeDelimiterOffset(str, skipLeadingAsciiWhitespace, skipTrailingAsciiWhitespace) != -1) {
                if (str.regionMatches(true, skipLeadingAsciiWhitespace, "https:", 0, 6)) {
                    ...
                    throw new IllegalArgumentException("Expected URL scheme 'http' or 'https' but was '" + str.substring(0, schemeDelimiterOffset) + CommonConstant.Symbol.SINGLE_QUOTES);
                }
        ...
        while (i < i2) {
            ...
            if (codePointAt == 37 && (i3 = i + 2) < i2) {
                ...
                if (decodeHexDigit != -1 && decodeHexDigit2 != -1) {
                    cVar.h((decodeHexDigit << 4) + decodeHexDigit2);
                    i = i3;
                }
                cVar.a(codePointAt);
            } else {
    ...
    static void canonicalize(c cVar, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        c cVar2 = null;
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
