...
public final class Cache implements Closeable, Flushable {
        ...
        return new Iterator<String>() { // from class: okhttp3.Cache.2
            ...
            public boolean hasNext() {
                ...
                while (this.delegate.hasNext()) {
                    ...
                    try {
                        this.nextUrl = m.a(next.getSource(0)).q();
                        return true;
                    } catch (IOException unused) {
                    } finally {
                        next.close();
    ...
    public final class CacheRequestImpl implements CacheRequest {
        ...
        CacheRequestImpl(final DiskLruCache.Editor editor) {
            ...
            this.body = new h(this.cacheOut) { // from class: okhttp3.Cache.CacheRequestImpl.1
    ...
    public static final class Entry {
        ...
        Entry(s sVar) throws IOException {
            ...
            try {
                ...
                StatusLine parse = StatusLine.parse(a.q());
        ...
        public final void writeTo(DiskLruCache.Editor editor) throws IOException {
            ...
            a.n(this.varyHeaders.size()).h(10);
            ...
            a.n(this.responseHeaders.size() + 2).h(10);
            int size2 = this.responseHeaders.size();
            for (int i2 = 0; i2 < size2; i2++) {
                a.b(this.responseHeaders.name(i2)).b(": ").b(this.responseHeaders.value(i2)).h(10);
            }
            a.b(SENT_MILLIS).b(": ").n(this.sentRequestMillis).h(10);
            a.b(RECEIVED_MILLIS).b(": ").n(this.receivedResponseMillis).h(10);
            if (isHttps()) {
                a.h(10);
        ...
        private boolean isHttps() {
            return this.url.startsWith(AbsApiFactory.HTTPS);
        }
        ...
        private void writeCertList(d dVar, List<Certificate> list) throws IOException {
            try {
                ...
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    dVar.b(f.a(list.get(i).getEncoded()).b()).h(10);
                }
    ...
    public static class CacheResponseBody extends ResponseBody {
        ...
        CacheResponseBody(final DiskLruCache.Snapshot snapshot, String str, String str2) {
            ...
            this.bodySource = m.a(new i(snapshot.getSource(1)) { // from class: okhttp3.Cache.CacheResponseBody.1
