...
public final class Http2 {
    ...
    private static final String[] FRAME_NAMES = {"DATA", PlayerBuilder.KEY_HEADERS, "PRIORITY", "RST_STREAM", "SETTINGS", "PUSH_PROMISE", CSCallUris.SVID_CALL_PING, "GOAWAY", "WINDOW_UPDATE", "CONTINUATION"};
    ...
    static {
        ...
        for (int i2 = 0; i2 < BINARY.length; i2++) {
            BINARY[i2] = Util.format("%8s", Integer.toBinaryString(i2)).replace(Constants.SPACE, '0');
        }
        FLAGS[0] = "";
        FLAGS[1] = "END_STREAM";
        int[] iArr = {1};
        ...
        for (int i3 = 0; i3 <= 0; i3++) {
            FLAGS[iArr[i3] | 8] = FLAGS[i] + "|PADDED";
        }
        FLAGS[4] = "END_HEADERS";
        FLAGS[32] = "PRIORITY";
    ...
    static String formatFlags(byte b, byte b2) {
        ...
        switch (b) {
            ...
            case 4:
            case 6:
                return b2 == 1 ? CSCallUris.SVID_CALL_ACK : BINARY[b2];
            case 5:
            default:
                ...
                return str.replace(PlayerBuilder.KEY_HEADERS, "PUSH_PROMISE");
        }
    }
}
