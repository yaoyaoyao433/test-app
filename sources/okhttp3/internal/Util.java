...
public final class Util {
    ...
    public static final Charset ISO_8859_1 = Charset.forName(CommonConstant.Encoding.ISO88591);
    ...
    public static String hostHeader(HttpUrl httpUrl, boolean z) {
        String host;
        if (httpUrl.host().contains(CommonConstant.Symbol.COLON)) {
            host = "[" + httpUrl.host() + CommonConstant.Symbol.MIDDLE_BRACKET_RIGHT;
        } else {
            host = httpUrl.host();
        }
        if (z || httpUrl.port() != HttpUrl.defaultPort(httpUrl.scheme())) {
            return host + CommonConstant.Symbol.COLON + httpUrl.port();
        }
        return host;
    }
    ...
    public static String canonicalizeHost(String str) {
        ...
        if (str.contains(CommonConstant.Symbol.COLON)) {
            ...
            throw new AssertionError("Invalid IPv6 address: '" + str + CommonConstant.Symbol.SINGLE_QUOTES);
        }
        try {
