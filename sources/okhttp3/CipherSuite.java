...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_RSA_WITH_SEED_CBC_SHA = init("TLS_RSA_WITH_SEED_CBC_SHA", MapConstant.ANIMATION_DURATION_SHORT);
    public static final CipherSuite TLS_RSA_WITH_AES_128_GCM_SHA256 = init("TLS_RSA_WITH_AES_128_GCM_SHA256", Constants.ERR_PUBLISH_STREAM_FORMAT_NOT_SUPPORTED);
