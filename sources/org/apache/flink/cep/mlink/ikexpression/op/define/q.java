...
public final class q implements org.apache.flink.cep.mlink.ikexpression.op.a {
    public static final org.apache.flink.cep.mlink.ikexpression.op.b a = org.apache.flink.cep.mlink.ikexpression.op.b.PLUS;
    ...
    public final org.apache.flink.cep.mlink.ikexpression.datameta.b a(org.apache.flink.cep.mlink.ikexpression.datameta.b[] bVarArr) throws org.apache.flink.cep.mlink.ikexpression.b {
        ...
        if (a.EnumC1538a.DATATYPE_NULL == bVar.a() || a.EnumC1538a.DATATYPE_NULL == bVar2.a() || bVar.b == null || bVar2.b == null) {
            return new org.apache.flink.cep.mlink.ikexpression.datameta.b(a.EnumC1538a.DATATYPE_NULL, null);
        }
        if (a.EnumC1538a.DATATYPE_LIST == bVar.a() || a.EnumC1538a.DATATYPE_LIST == bVar2.a()) {
            return new org.apache.flink.cep.mlink.ikexpression.datameta.b(a.EnumC1538a.DATATYPE_NULL, null);
        }
        if (a.EnumC1538a.DATATYPE_STRING == bVar.a() || a.EnumC1538a.DATATYPE_STRING == bVar2.a() || a.EnumC1538a.DATATYPE_BOOLEAN == bVar.a() || a.EnumC1538a.DATATYPE_BOOLEAN == bVar2.a() || a.EnumC1538a.DATATYPE_DATE == bVar.a() || a.EnumC1538a.DATATYPE_DATE == bVar2.a()) {
            String c = bVar.c() != null ? bVar.c() : "";
            String c2 = bVar2.c() != null ? bVar2.c() : "";
            return new org.apache.flink.cep.mlink.ikexpression.datameta.b(a.EnumC1538a.DATATYPE_STRING, c + c2);
        } else if (a.EnumC1538a.DATATYPE_DOUBLE == bVar.a() || a.EnumC1538a.DATATYPE_DOUBLE == bVar2.a()) {
