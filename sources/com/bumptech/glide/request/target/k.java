...
public final class k extends PicassoDrawable {
    private PicassoDrawable a;
    private a b;
    private boolean c;

    public k(PicassoDrawable picassoDrawable, int i) {
        this(new a(picassoDrawable.getConstantState(), i), picassoDrawable, null);
    }

    protected k(a aVar, PicassoDrawable picassoDrawable, Resources resources) {
        this.b = aVar;
