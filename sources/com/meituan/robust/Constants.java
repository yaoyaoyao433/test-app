...
public class Constants {
    ...
    public static final String METHOD_MAP_OUT_PATH;
    public static final String METHOD_VALUE_MAP_OUT_PATH;
    ...
    public static final String PATCH_CONTROL_SUFFIX = "PatchControl";
    ...
    public static final String DEFAULT_OLD_MAPPING_FILE = "/robust/old/mapping.txt".replace("/", File_SEPARATOR);
    ...
    static {
        ...
        METHOD_MAP_OUT_PATH = "/outputs/robust/methodsMap.robust".replace("/", File_SEPARATOR);
        METHOD_VALUE_MAP_OUT_PATH = "/outputs/robust/methodValuesMap.robust".replace("/", File_SEPARATOR);
