...
public final class af implements ak {
    ...
    public final boolean a(com.meituan.msi.api.component.canvas.f fVar, Canvas canvas, JsonArray jsonArray) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "d7cda9631862759cfa0cf7cc5aaba9b1", RobustBitConfig.DEFAULT_VALUE)) {
            return ((Boolean) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "d7cda9631862759cfa0cf7cc5aaba9b1")).booleanValue();
        }
        if (jsonArray.size() < 6) {
            return false;
        }
