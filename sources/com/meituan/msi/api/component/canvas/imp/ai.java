...
public final class ai implements ak {
    ...
    public final boolean a(com.meituan.msi.api.component.canvas.f fVar, Canvas canvas, JsonArray jsonArray) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "d912212e0cd24239c8bf2fd2bb3fd6b6", RobustBitConfig.DEFAULT_VALUE)) {
            return ((Boolean) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "d912212e0cd24239c8bf2fd2bb3fd6b6")).booleanValue();
        }
        if (jsonArray.size() < 3) {
            return false;
        }
