...
public final class b extends a {
    ...
    public final com.sankuai.meituan.retrofit2.raw.b a(Interceptor.a aVar) throws IOException, com.meituan.android.neohybrid.exception.a {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "0efdb382e654160c29bb72f72ec464d9", RobustBitConfig.DEFAULT_VALUE)) {
            return (com.sankuai.meituan.retrofit2.raw.b) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "0efdb382e654160c29bb72f72ec464d9");
        }
        ...
        try {
            aVar2 = com.meituan.android.neohybrid.neo.http.encrypt.b.a(request.i());
        ...
        try {
            try {
                ...
                ChangeQuickRedirect changeQuickRedirect2 = com.meituan.android.neohybrid.neo.http.encrypt.a.a;
                if (PatchProxy.isSupport(objArr2, null, changeQuickRedirect2, true, "314828f0fab594a461218a1a831e4d0e", RobustBitConfig.DEFAULT_VALUE)) {
                    body = (ap) PatchProxy.accessDispatch(objArr2, null, changeQuickRedirect2, true, "314828f0fab594a461218a1a831e4d0e");
                    ...
                    body = body2.newBuilder().a("application/json;charset=UTF-8").a(b2.getBytes().length).a(new ByteArrayInputStream(com.meituan.android.neohybrid.neo.http.encrypt.a.b(str2, body2.string()).getBytes())).a();
                }
