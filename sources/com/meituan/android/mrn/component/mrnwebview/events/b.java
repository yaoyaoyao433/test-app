...
public final class b extends com.facebook.react.uimanager.events.b<b> {
    ...
    /* compiled from: ProGuard */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lcom/meituan/android/mrn/component/mrnwebview/events/TopLoadingFinishEvent$Companion;", "", "()V", "EVENT_NAME", "", "library_release"}, k = 1, mv = {1, 1, 15})
    /* loaded from: classes2.dex */
    ...
    public b(int i, @NotNull WritableMap writableMap) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "e39814cc28bfac02413bc35c7b0021a1", 6917529027641081856L)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "e39814cc28bfac02413bc35c7b0021a1");
        } else {
            this.c = writableMap;
        }
    }
    ...
    public final void a(@NotNull RCTEventEmitter rCTEventEmitter) {
        ...
        ChangeQuickRedirect changeQuickRedirect = a;
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "396d7d3aa1e6f556d101bf5a5a7e2a7e", RobustBitConfig.DEFAULT_VALUE)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "396d7d3aa1e6f556d101bf5a5a7e2a7e");
            return;
        }
        h.b(rCTEventEmitter, "rctEventEmitter");
        rCTEventEmitter.receiveEvent(e(), "topLoadingFinish", this.c);
    }
}
