...
public class ResponseWrap {
    ...
    public boolean fromJson(String str) {
        try {
            ...
            this.responseHeader.setErrorCode(JsonUtil.getIntValue(jSONObject, AlitaMonitorCenter.AlitaMonitorConst.BaseAvailability.TAG_KEY_ERROR_CODE));
    ...
    public String toJson() {
        ...
        try {
            ...
            jSONObject.put(AlitaMonitorCenter.AlitaMonitorConst.BaseAvailability.TAG_KEY_ERROR_CODE, this.responseHeader.getErrorCode());
