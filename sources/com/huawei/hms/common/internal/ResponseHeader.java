...
public class ResponseHeader implements ResponseErrorCode, IMessageEntity {
    ...
    public boolean fromJson(String str) {
        try {
            ...
            this.error_code = JsonUtil.getIntValue(jSONObject, AlitaMonitorCenter.AlitaMonitorConst.BaseAvailability.TAG_KEY_ERROR_CODE);
    ...
    public String getActualAppID() {
        ...
        String[] split = this.app_id.split(RecceBridgeHandler.RECCE_BRIDGE_ARGS_SEPARATOR);
        if (split.length == 0) {
            return "";
        }
        if (split.length == 1) {
    ...
    public String toJson() {
        ...
        try {
            ...
            jSONObject.put(AlitaMonitorCenter.AlitaMonitorConst.BaseAvailability.TAG_KEY_ERROR_CODE, this.error_code);
