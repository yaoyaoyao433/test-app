...
public class PluginUtil {
    public static void a(Context context, String str, String str2, String str3) {
        ...
        intent.putExtra("selfshow_info", str3.getBytes(w.a));
        intent.putExtra("selfshow_token", str2.getBytes(w.a));
    ...
    public static boolean onDataMessage(Context context, String str, String str2, boolean z) {
        ...
        bundle.putByteArray(RemoteMessageConst.MSGBODY, str2.getBytes(w.a));
