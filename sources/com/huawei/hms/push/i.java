...
public class i {
    ...
    public static void a(Context context, Intent intent, byte[] bArr, byte[] bArr2) {
        String a = com.sankuai.waimai.platform.utils.f.a(intent, "selfshow_event_id");
        int a2 = com.sankuai.waimai.platform.utils.f.a(intent, "selfshow_notify_id", 0);
        HMSLog.i("PushSelfShowLog", "get notifyId:" + a2);
        k kVar = new k(bArr, bArr2);
        if (!kVar.z()) {
            HMSLog.d("PushSelfShowLog", "parseMessage failed");
            return;
        }
        HMSLog.i("PushSelfShowLog", "onReceive the msg id = " + kVar.p() + ",and cmd is " + kVar.i() + ",and the eventId is " + a);
        if (a == null) {
            a(context, intent, kVar);
        } else {
            a(context, intent, a, kVar, a2);
        }
    }
