...
public class HmsMessaging {
    ...
    public final com.huawei.hmf.tasks.f<Void> a(String str, String str2) {
        ...
        if (str != null && a.matcher(str).matches()) {
            ...
            try {
                ...
                gVar2.a((Exception) ErrorEnum.ERROR_INTERNAL_ERROR.toApiException());
    ...
    public com.huawei.hmf.tasks.f<Void> subscribe(String str) {
        HMSLog.i("HmsMessaging", "invoke subscribe");
        return a(str, "Sub");
    }

    public com.huawei.hmf.tasks.f<Void> turnOffPush() {
        if (ProxyCenter.getProxy() != null) {
    ...
    public com.huawei.hmf.tasks.f<Void> turnOnPush() {
        if (ProxyCenter.getProxy() != null) {
    ...
    public com.huawei.hmf.tasks.f<Void> unsubscribe(String str) {
    ...
    public final com.huawei.hmf.tasks.f<Void> a(boolean z) {
        ...
        if (s.d(this.b) && !s.b()) {
            if (HwBuildEx.VERSION.EMUI_SDK_INT < 12) {
                ...
                return com.huawei.hmf.tasks.i.a(new IntentCallable(this.b, putExtra, reportEntry));
            } else {
                ...
                return com.huawei.hmf.tasks.i.a(new IntentCallable(this.b, intent, reportEntry));
            }
        }
