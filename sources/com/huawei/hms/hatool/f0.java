...
public class f0 {
    ...
    /* loaded from: classes2.dex */
    public class a {
        public String a = UUID.randomUUID().toString().replace(CommonConstant.Symbol.MINUS, "");
        public boolean b = true;
        public long c;

        public a(long j) {
            this.a += CommonConstant.Symbol.UNDERLINE + j;
            this.c = j;
            f0.this.b = false;
        }
        ...
        public final void b(long j) {
            ...
            this.a = this.a.replace(CommonConstant.Symbol.MINUS, "");
            this.a += CommonConstant.Symbol.UNDERLINE + j;
            this.c = j;
            this.b = true;
        }
