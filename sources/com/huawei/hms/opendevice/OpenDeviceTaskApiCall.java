...
public class OpenDeviceTaskApiCall extends TaskApiCall<OpenDeviceHmsClient, OdidResult> {
    ...
    @Override // com.huawei.hms.common.internal.TaskApiCall
    public void doExecute(OpenDeviceHmsClient openDeviceHmsClient, ResponseErrorCode responseErrorCode, String str, com.huawei.hmf.tasks.g<OdidResult> gVar) {
        if (responseErrorCode == null) {
            gVar.a(new ApiException(new Status(1)));
            return;
        }
        HiAnalyticsClient.reportExit(openDeviceHmsClient.getContext(), getUri(), getTransactionId(), responseErrorCode.getStatusCode(), responseErrorCode.getErrorCode(), 50101300);
        if (responseErrorCode.getErrorCode() == 0) {
            ...
            gVar.a((com.huawei.hmf.tasks.g<OdidResult>) odidResult);
            return;
        }
