...
public class n {
    ...
    public static String c(Context context, String str, String str2) {
        try {
            ...
            jSONObject2.put(GearsLocator.COUNTRY, SystemUtils.getLocalCountry());
            ...
            jSONObject.put("app_id", com.huawei.agconnect.config.a.a(context).a("client/app_id"));
            jSONObject.put("region", com.huawei.agconnect.config.a.a(context).a("region"));
