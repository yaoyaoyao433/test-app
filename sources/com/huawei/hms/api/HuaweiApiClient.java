    ...
    public static final class Builder {
        ...
        private void a(HuaweiApiClient huaweiApiClient) {
            ...
            if (autoLifecycleFragment == null) {
                ...
                autoLifecycleFragment.startAutoMange(this.g, huaweiApiClient);
            }
        }
        ...
        public final <O extends Api.ApiOptions.HasOptions> Builder addApiWithScope(Api<O> api, O o, Scope... scopeArr) {
            Checker.checkNonNull(api, "Api must not be null");
