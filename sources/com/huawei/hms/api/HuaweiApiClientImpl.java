...
public class HuaweiApiClientImpl extends HuaweiApiClient implements ServiceConnection, InnerApiClient {
    ...
    public class a implements CheckUpdateCallBack {
        ...
        public void onMarketInstallInfo(Intent intent) {
            if (intent != null) {
                int a = com.sankuai.waimai.platform.utils.f.a(intent, UpdateKey.MARKET_DLD_STATUS, -99);
                int a2 = com.sankuai.waimai.platform.utils.f.a(intent, UpdateKey.MARKET_INSTALL_STATE, -99);
                int a3 = com.sankuai.waimai.platform.utils.f.a(intent, UpdateKey.MARKET_INSTALL_TYPE, -99);
                HMSLog.i("HuaweiApiClientImpl", "onMarketInstallInfo installState: " + a2 + ",installType: " + a3 + ",downloadCode: " + a);
            }
        }
        ...
        public void onUpdateInfo(Intent intent) {
            ...
            try {
                int a = com.sankuai.waimai.platform.utils.f.a(intent, "status", -99);
                int a2 = com.sankuai.waimai.platform.utils.f.a(intent, UpdateKey.FAIL_CODE, -99);
                boolean a3 = com.sankuai.waimai.platform.utils.f.a(intent, UpdateKey.MUST_UPDATE, false);
                HMSLog.i("HuaweiApiClientImpl", "onUpdateInfo status: " + a + ",failcause: " + a2 + ",isExit: " + a3);
                if (a == 7) {
                    ApkUpgradeInfo apkUpgradeInfo = (ApkUpgradeInfo) com.sankuai.waimai.platform.utils.f.c(intent, UpdateKey.INFO);
    ...
    private void i() {
        ...
        this.x.sendEmptyMessageDelayed(2, MetricsAnrManager.ANR_THRESHOLD);
    }
    ...
    private void j() {
        synchronized (C) {
            ...
            boolean sendEmptyMessageDelayed = this.y.sendEmptyMessageDelayed(3, PayTask.j);
    ...
    public boolean isConnected() {
        ...
        if (this.q < 20504000) {
            ...
            if (innerIsConnected()) {
                Status status = ConnectService.checkconnect(this, new CheckConnectInfo()).awaitOnAnyThread(ExposeAction.DEFAULT_DELAY_FOR_AUTO_EXPOSE, TimeUnit.MILLISECONDS).getStatus();
                if (status.isSuccess()) {
