...
public class ForegroundBusDelegate implements IBridgeActivityDelegate {
    ...
    public void onBridgeActivityCreate(Activity activity) {
        ...
        String a = f.a(intent, HMS_FOREGROUND_REQ_HEADER);
        this.foregroundHeader = new RequestHeader();
        if (!this.foregroundHeader.fromJson(a)) {
            errorReturn(0, "header is invalid");
            return;
        }
        this.foregroundBody = f.a(intent, HMS_FOREGROUND_REQ_BODY);
        this.innerHeader.fromJson(f.a(intent, HMS_FOREGROUND_REQ_INNER));
    ...
    public boolean onBridgeActivityResult(int i, int i2, Intent intent) {
        if (i == REQUEST_CODE_BUS) {
            if (intent != null && intent.hasExtra(HMS_FOREGROUND_RESP_HEADER)) {
                String a = f.a(intent, HMS_FOREGROUND_RESP_HEADER);
                this.responseHeader = new ResponseHeader();
                JsonUtil.jsonToEntity(a, this.responseHeader);
            }
