...
public class HmsInstanceId {
    ...
    public final void a(String str) {
        ...
        if (p.c(this.a)) {
            ...
            if (TextUtils.isEmpty(string)) {
                ...
                i a = i.a(this.a);
                a.saveString("subjectId", string + CommonConstant.Symbol.COMMA + str);
                return;
            }
        }
    ...
    public f<AAIDResult> getAAID() {
        try {
            return com.huawei.hmf.tasks.i.a(new j(this.a.getApplicationContext()));
        } catch (Exception unused) {
            g gVar = new g();
    ...
    public final String a(TokenReq tokenReq, int i) throws ApiException {
        ...
        try {
            ...
            lVar.setApiLevel(i);
            return ((TokenResult) com.huawei.hmf.tasks.i.a(this.c.doWrite(lVar))).getToken();
        } catch (Exception e) {
    ...
    public final void a(DeleteTokenReq deleteTokenReq, int i) throws ApiException {
        ...
        try {
            ...
            kVar.setApiLevel(i);
            com.huawei.hmf.tasks.i.a(this.c.doWrite(kVar));
