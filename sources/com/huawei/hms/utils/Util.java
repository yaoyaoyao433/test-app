...
public class Util {
    ...
    public static String getProductCountry() {
        ...
        if (TextUtils.isEmpty(systemProperties)) {
            ...
            if (!TextUtils.isEmpty(systemProperties2) && (lastIndexOf = systemProperties2.lastIndexOf(CommonConstant.Symbol.MINUS)) != -1) {
    ...
    public static String getServiceActionMetadata(Context context) {
        ...
        try {
            ApplicationInfo applicationInfo = packageManager.getPackageInfo(context.getPackageName(), 128).applicationInfo;
            if (applicationInfo != null && applicationInfo.metaData != null && (obj = applicationInfo.metaData.get(SERVICE_ACTION)) != null) {
                String valueOf = String.valueOf(obj);
                if (!TextUtils.isEmpty(valueOf)) {
            ...
            HMSLog.i(TAG, "In getServiceActionMetadata, Failed to read meta data for the SERVICE ACTION.");
        } catch (PackageManager.NameNotFoundException unused) {
            HMSLog.w(TAG, "In getServiceActionMetadata, Failed to read meta data for the SERVICE ACTION.");
        }
        serviceAction = "";
        return "";
    }
