...
public final class cg {
    ...
    public static boolean a(Context context, String str) {
        try {
            ...
            com.xiaomi.channel.commonutils.logger.c.a("checkService " + e);
            return false;
        }
    }
    ...
    public static boolean a(Context context, String str, String str2) {
        try {
            ...
            com.xiaomi.channel.commonutils.logger.c.a("checkService action: " + str2 + ", " + e);
            return false;
        }
    }
    ...
    public static boolean b(Context context, String str) {
        ...
        try {
            ...
            com.xiaomi.channel.commonutils.logger.c.a("checkProvider " + e);
        }
        return z;
    }
    ...
    public static boolean b(Context context, String str, String str2) {
        try {
            ...
            com.xiaomi.channel.commonutils.logger.c.a("checkActivity action: " + str2 + ", " + e);
            return false;
        }
    }
}
