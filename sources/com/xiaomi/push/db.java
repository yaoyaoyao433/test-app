...
public final class db {
    ...
    public static String b(String str) {
        return ar.a(Base64.decode(str, 2));
    }
        ...
        if (hashMap != null) {
            ...
            if (!TextUtils.isEmpty(str)) {
                try {
                    ...
                    hashMap2.put(ErrorCode.ERROR_TYPE_B, String.valueOf(jSONObject.opt("awakened_app")));
                    hashMap2.put(ShowLogJsHandler.PARAM_NAME_MODULE, String.valueOf(jSONObject.opt("awake_type")));
                } catch (JSONException e) {
                    com.xiaomi.channel.commonutils.logger.c.a(e);
                }
            }
