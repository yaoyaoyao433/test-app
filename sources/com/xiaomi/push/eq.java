...
public enum eq {
    ...
    GSLB_TCP_NOACCESS(XPlayerConstants.FFP_PROP_FLOAT_GOP_FRAME),
    ...
    GSLB_ERR(10999),
    CONN_SUCCESS(UserCenter.TYPE_LOGOUT_NEGATIVE),
    ...
    public static eq a(int i) {
        switch (i) {
            ...
            default:
                switch (i) {
                    case XPlayerConstants.FFP_PROP_FLOAT_GOP_FRAME /* 10101 */:
