...
public class TransactionDetailsResult implements Parcelable {
    public static final Parcelable.Creator<TransactionDetailsResult> CREATOR = new Parcelable.Creator<TransactionDetailsResult>() { // from class: com.unionpay.tsmservice.mi.result.TransactionDetailsResult.1
