...
public final class b {
    ...
    public static /* synthetic */ void a(b bVar, Bundle bundle) {
        ...
        if (!TextUtils.isEmpty(bVar.e) && bVar.a != null) {
            UPUtils.a(bVar.a, bVar.e, "se_type");
        }
        switch (i) {
            case 0:
                if (i2 <= 0) {
                    ...
                    if (bVar.b != null) {
                        bVar.b.onResult(str5, str6, i2, bundle);
                        return;
                    }
                    return;
                }
    ...
    public final int a() {
        ...
        } else if (com.unionpay.utils.b.d(this.a, "com.unionpay.tsmservice")) {
            str = this.d;
            str2 = this.e;
