...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<Boolean> BOOLEAN_AS_STRING = new TypeAdapter<Boolean>() { // from class: com.google.gson.internal.bind.TypeAdapters.4
        ...
        @Override // com.google.gson.TypeAdapter
        public final void write(JsonWriter jsonWriter, Boolean bool) throws IOException {
            jsonWriter.value(bool == null ? StringUtil.NULL : bool.toString());
        }
    };
    ...
    public static final TypeAdapter<URL> URL = new TypeAdapter<URL>() { // from class: com.google.gson.internal.bind.TypeAdapters.21
        ...
        public final URL read(JsonReader jsonReader) throws IOException {
            ...
            String nextString = jsonReader.nextString();
            if (StringUtil.NULL.equals(nextString)) {
                return null;
            }
    ...
    public static final TypeAdapter<Locale> LOCALE = new TypeAdapter<Locale>() { // from class: com.google.gson.internal.bind.TypeAdapters.28
        ...
        public final Locale read(JsonReader jsonReader) throws IOException {
            ...
            StringTokenizer stringTokenizer = new StringTokenizer(jsonReader.nextString(), CommonConstant.Symbol.UNDERLINE);
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final TypeAdapter<TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.32
            ...
            public final String toString() {
                return "Factory[type=" + cls.getName() + ",adapter=" + typeAdapter + CommonConstant.Symbol.MIDDLE_BRACKET_RIGHT;
            }
        };
    }
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final Class<TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.33
            ...
            public final String toString() {
                return "Factory[type=" + cls2.getName() + "+" + cls.getName() + ",adapter=" + typeAdapter + CommonConstant.Symbol.MIDDLE_BRACKET_RIGHT;
            }
        };
    }
    ...
    public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(final Class<TT> cls, final Class<? extends TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.34
            ...
            public final String toString() {
                return "Factory[type=" + cls.getName() + "+" + cls2.getName() + ",adapter=" + typeAdapter + CommonConstant.Symbol.MIDDLE_BRACKET_RIGHT;
            }
        };
    }
    ...
    public static <T1> TypeAdapterFactory newTypeHierarchyFactory(final Class<T1> cls, final TypeAdapter<T1> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.35
            ...
            public final String toString() {
                return "Factory[typeHierarchy=" + cls.getName() + ",adapter=" + typeAdapter + CommonConstant.Symbol.MIDDLE_BRACKET_RIGHT;
            }
        };
    }
}
