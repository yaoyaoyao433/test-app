...
public class JsonWriter implements Closeable, Flushable {
    ...
    public JsonWriter(Writer writer) {
        push(6);
        this.separator = CommonConstant.Symbol.COLON;
    ...
    public JsonWriter endArray() throws IOException {
        return close(1, 2, CommonConstant.Symbol.MIDDLE_BRACKET_RIGHT);
    }

    public JsonWriter beginObject() throws IOException {
        writeDeferredName();
        return open(3, CommonConstant.Symbol.BIG_BRACKET_LEFT);
    }

    public JsonWriter endObject() throws IOException {
        return close(3, 5, CommonConstant.Symbol.BIG_BRACKET_RIGHT);
    }
    ...
    public JsonWriter nullValue() throws IOException {
        ...
        beforeValue();
        this.out.write(StringUtil.NULL);
        return this;
    }
