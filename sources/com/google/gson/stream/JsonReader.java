...
import com.meituan.android.recce.props.gens.AutoComplete;
...
public class JsonReader implements Closeable {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:51:0x0091, code lost:
        if (isLiteral(r14) == false) goto L10;
     */
    ...
    */
    ...
    private boolean isLiteral(char c) throws IOException {
        switch (c) {
            ...
            case ',':
            case ':':
            case IsShow.INDEX_ID /* 91 */:
            case AutoCorrect.INDEX_ID /* 93 */:
            case '{':
            case '}':
                return false;
            case '#':
    ...
    */
    ...
    public void skipValue() throws IOException {
        ...
        int i3 = this.stackSize - 1;
        iArr[i3] = iArr[i3] + 1;
        this.pathNames[this.stackSize - 1] = StringUtil.NULL;
    }
    ...
    public String getPath() {
        StringBuilder sb = new StringBuilder(CommonConstant.Symbol.DOLLAR);
        int i = this.stackSize;
