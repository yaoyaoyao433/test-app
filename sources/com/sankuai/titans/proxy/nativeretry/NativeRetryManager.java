...
public class NativeRetryManager {
    ...
    public NativeRetryManager(Context context) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "8bcbeeb008c1acd5abe6ebb4284342a7", 6917529027641081856L)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "8bcbeeb008c1acd5abe6ebb4284342a7");
        } else {
    ...
    public static NativeRetryManager getInstance(Context context) {
        Object[] objArr = {context};
        ChangeQuickRedirect changeQuickRedirect2 = changeQuickRedirect;
        if (PatchProxy.isSupport(objArr, null, changeQuickRedirect2, true, "5b8083deecf700d03809cdf895af12a7", RobustBitConfig.DEFAULT_VALUE)) {
            return (NativeRetryManager) PatchProxy.accessDispatch(objArr, null, changeQuickRedirect2, true, "5b8083deecf700d03809cdf895af12a7");
        }
        if (sInstance == null) {
    ...
    public WebResourceResponse getRetryResponse(WebResourceRequest webResourceRequest) throws IOException {
        ...
        ChangeQuickRedirect changeQuickRedirect2 = changeQuickRedirect;
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "2227ee8c4419eb8899948566fd901455", RobustBitConfig.DEFAULT_VALUE)) {
            return (WebResourceResponse) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "2227ee8c4419eb8899948566fd901455");
        }
        if ("GET".equals(webResourceRequest.getMethod())) {
            ...
            hashMap.put(KEY_HEADER_NETWORK, NetworkUtils.getNetworkTypeString(this.mContext, "pt-f80fb8336a87b895"));
