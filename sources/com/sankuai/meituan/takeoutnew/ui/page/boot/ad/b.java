...
public final class b {
    ...
    private Context c;
    private final AdFileDownloadService d;
    ...
    static {
        ...
        b = c.a("Page-FileDownloader", f, g, 30L, TimeUnit.SECONDS, h);
    }

    public b(Context context) {
        Object[] objArr = {context};
        ChangeQuickRedirect changeQuickRedirect = a;
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "e6de8dd7a1bb8191aeff39b3bd3c5edf", 6917529027641081856L)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "e6de8dd7a1bb8191aeff39b3bd3c5edf");
            return;
        }
        this.c = context;
        Object[] objArr2 = new Object[0];
        ChangeQuickRedirect changeQuickRedirect2 = a;
        this.d = (AdFileDownloadService) (PatchProxy.isSupport(objArr2, this, changeQuickRedirect2, false, "d2cdf73fbe6821b306defa7c12f385ba", RobustBitConfig.DEFAULT_VALUE) ? (ar) PatchProxy.accessDispatch(objArr2, this, changeQuickRedirect2, false, "d2cdf73fbe6821b306defa7c12f385ba") : new ar.a().a(b).b(b).a("https://s3plus.sankuai.com").a(i.a(new d() { // from class: com.sankuai.meituan.takeoutnew.ui.page.boot.ad.b.1
            public static ChangeQuickRedirect a;
            ...
            public final void a(OkHttpClient.Builder builder) {
                ...
                if (PatchProxy.isSupport(objArr3, this, changeQuickRedirect3, false, "46770a84f9158c7787a23f61b91e4746", RobustBitConfig.DEFAULT_VALUE)) {
                    PatchProxy.accessDispatch(objArr3, this, changeQuickRedirect3, false, "46770a84f9158c7787a23f61b91e4746");
                } else {
                    builder.connectTimeout(30L, TimeUnit.SECONDS).writeTimeout(30L, TimeUnit.SECONDS).readTimeout(30L, TimeUnit.SECONDS);
                }
            }
        })).a()).a(AdFileDownloadService.class);
    }

    public final void a(final String str, final a aVar) {
        Object[] objArr = {str, aVar};
        ChangeQuickRedirect changeQuickRedirect = a;
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "8e6fb9074d5758ed3f9715a1ac2da02e", RobustBitConfig.DEFAULT_VALUE)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "8e6fb9074d5758ed3f9715a1ac2da02e");
            ...
            final com.sankuai.meituan.takeoutnew.ui.page.boot.ad.a aVar2 = new com.sankuai.meituan.takeoutnew.ui.page.boot.ad.a(this.c);
            aVar2.a(str);
            if (aVar2.c()) {
                return;
            }
            try {
                this.d.downloadFile(str).a(new f<ap>() { // from class: com.sankuai.meituan.takeoutnew.ui.page.boot.ad.b.2
                    public static ChangeQuickRedirect a;
                    ...
                    */
                    public final void onResponse(com.sankuai.meituan.retrofit2.Call<com.sankuai.meituan.retrofit2.ap> r12, com.sankuai.meituan.retrofit2.Response<com.sankuai.meituan.retrofit2.ap> r13) {
                        /*
                            ...
                            r12 = 1
                            r0[r12] = r13
                            com.meituan.robust.ChangeQuickRedirect r12 = com.sankuai.meituan.takeoutnew.ui.page.boot.ad.b.AnonymousClass2.a
                            java.lang.String r9 = "334086b8a22322bfc056473377cbbe91"
                            r4 = 0
                        ...
                        L1e:
                            ...
                            com.sankuai.meituan.takeoutnew.ui.page.boot.ad.b$a r0 = r3     // Catch: java.lang.Exception -> L58 java.lang.Throwable -> L71
                            if (r0 != 0) goto L41
                            if (r13 == 0) goto L40
                        ...
                        L41:
                            if (r12 == 0) goto L4b
                            com.sankuai.meituan.takeoutnew.ui.page.boot.ad.b$a r12 = r3     // Catch: java.lang.Exception -> L58 java.lang.Throwable -> L71
                        ...
                        L5f:
                            ...
                            r12 = r10
                        L63:
                            com.sankuai.meituan.takeoutnew.ui.page.boot.ad.b$a r0 = r3     // Catch: java.lang.Throwable -> L71
                            if (r0 == 0) goto L6e
                            com.sankuai.meituan.takeoutnew.ui.page.boot.ad.b$a r0 = r3     // Catch: java.lang.Throwable -> L71
                        ...
                        L77:
                            throw r12
                        L78:
                            com.sankuai.meituan.takeoutnew.ui.page.boot.ad.b$a r12 = r3
                            if (r12 == 0) goto L83
                            com.sankuai.meituan.takeoutnew.ui.page.boot.ad.b$a r12 = r3
                        ...
                        L88:
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.sankuai.meituan.takeoutnew.ui.page.boot.ad.b.AnonymousClass2.onResponse(com.sankuai.meituan.retrofit2.Call, com.sankuai.meituan.retrofit2.Response):void");
                    }
                    ...
                    public final void onFailure(Call<ap> call, Throwable th) {
                        ...
                        ChangeQuickRedirect changeQuickRedirect2 = a;
                        if (PatchProxy.isSupport(objArr2, this, changeQuickRedirect2, false, "26949ebb8e23e350369339540165a89d", RobustBitConfig.DEFAULT_VALUE)) {
                            PatchProxy.accessDispatch(objArr2, this, changeQuickRedirect2, false, "26949ebb8e23e350369339540165a89d");
                            return;
                        }
