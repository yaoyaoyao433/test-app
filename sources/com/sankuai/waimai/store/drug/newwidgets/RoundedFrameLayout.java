...
public class RoundedFrameLayout extends FrameLayout {
    ...
    public RoundedFrameLayout(Context context) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "9fe9b8e3571ce6610f788a898eeaf242", 6917529027641081856L)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "9fe9b8e3571ce6610f788a898eeaf242");
        }
    }

    private RoundedFrameLayout(Context context, AttributeSet attributeSet) {
        this(context, null, 0);
        Object[] objArr = {context, null};
        ChangeQuickRedirect changeQuickRedirect = a;
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "c1ea3f89001a084fae31b831a01165a0", 6917529027641081856L)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "c1ea3f89001a084fae31b831a01165a0");
        }
    }
    ...
    public RoundedFrameLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        ChangeQuickRedirect changeQuickRedirect = a;
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "f991f9c1561d34e256d889d8a6e32a28", 6917529027641081856L)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "f991f9c1561d34e256d889d8a6e32a28");
            return;
        }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        ChangeQuickRedirect changeQuickRedirect = a;
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "2738543919b094a84e996253c76878b1", RobustBitConfig.DEFAULT_VALUE)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "2738543919b094a84e996253c76878b1");
            return;
        }
