...
public class NoResultNonDeliveryEntity extends StatisticsEntity implements Serializable {
    ...
    public NoResultNonDeliveryEntity() {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "34cd8c77aacbb6cb7881d03199256c6f", 6917529027641081856L)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "34cd8c77aacbb6cb7881d03199256c6f");
            return;
        }
