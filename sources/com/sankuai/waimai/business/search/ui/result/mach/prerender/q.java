...
public final class q extends p {
    ...
    public final CommonMachData a(OasisModule oasisModule, Serializable serializable, String str, String str2, SearchShareData searchShareData, Activity activity, int i) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "3f5b93ca52115a783ca55d52af807a21", RobustBitConfig.DEFAULT_VALUE)) {
            return (CommonMachData) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "3f5b93ca52115a783ca55d52af807a21");
        }
        ...
        com.sankuai.waimai.mach.recycler.c a3 = com.sankuai.waimai.business.search.ui.result.mach.b.a(SearchShareData.s, "waimai-search-supermarket-feed-2", "waimai-search-supermarket-feed-2", activity, a2, str, ((i - (com.sankuai.waimai.foundation.utils.g.a(activity, 12.0f) * 2)) - com.sankuai.waimai.foundation.utils.g.a(activity, 8.0f)) / 2, 0, null, aVar, null);
        aVar.b = a3;
        if (a3 != null) {
