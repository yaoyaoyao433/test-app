...
public final class l extends k {
    ...
    public final CommonMachData a(OasisModule oasisModule, Serializable serializable, String str, String str2, SearchShareData searchShareData, Activity activity, int i) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "b13cf67cf64ff4b55f36961cb34ab294", RobustBitConfig.DEFAULT_VALUE)) {
            return (CommonMachData) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "b13cf67cf64ff4b55f36961cb34ab294");
        }
        ...
        com.sankuai.waimai.mach.recycler.c a3 = com.sankuai.waimai.business.search.ui.result.mach.b.a(SearchShareData.s, "waimai-search-feed-intelligence-2", "waimai-search-feed-intelligence-2", activity, a2, str, ((i - (com.sankuai.waimai.foundation.utils.g.a(activity, 12.0f) * 2)) - com.sankuai.waimai.foundation.utils.g.a(activity, 8.0f)) / 2, 0, null, aVar, null);
        aVar.b = a3;
