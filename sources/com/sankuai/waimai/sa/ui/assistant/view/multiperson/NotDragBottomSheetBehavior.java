...
public class NotDragBottomSheetBehavior<V extends View> extends BottomSheetBehavior<V> {
    ...
    public NotDragBottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "c05b19f5d12d5720880ec3d9ce6bfc72", 6917529027641081856L)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "c05b19f5d12d5720880ec3d9ce6bfc72");
        }
    }
}
