...
public class e {
    ...
    public static Object b(XmlPullParser xmlPullParser, String[] strArr) throws XmlPullParserException, IOException {
        ...
        if (!name.equals(StringUtil.NULL)) {
            ...
            } else if (name.equals(Constants.DOUBLE)) {
                obj = Double.valueOf(xmlPullParser.getAttributeValue(null, "value"));
            } else if (name.equals(Constants.BOOLEAN)) {
                obj = Boolean.valueOf(xmlPullParser.getAttributeValue(null, "value"));
            } else if (name.equals("int-array")) {
                xmlPullParser.next();
                int[] m35a = m35a(xmlPullParser, "int-array", strArr);
                strArr[0] = attributeValue;
                return m35a;
            } else if (name.equals("map")) {
                xmlPullParser.next();
                HashMap m34a = m34a(xmlPullParser, "map", strArr);
                strArr[0] = attributeValue;
                return m34a;
            } else if (name.equals(Constants.EventInfoConsts.KEY_LX_INNER_DATAS_LIST)) {
                xmlPullParser.next();
                ArrayList a = a(xmlPullParser, Constants.EventInfoConsts.KEY_LX_INNER_DATAS_LIST, strArr);
                strArr[0] = attributeValue;
                return a;
            } else {
    ...
    public static final void a(Map map, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        if (map == null) {
            xmlSerializer.startTag(null, StringUtil.NULL);
            xmlSerializer.endTag(null, StringUtil.NULL);
            return;
        }
    ...
    public static final void a(List list, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        ...
        xmlSerializer.startTag(null, Constants.EventInfoConsts.KEY_LX_INNER_DATAS_LIST);
        if (str != null) {
            xmlSerializer.attribute(null, "name", str);
        }
        int size = list.size();
        ...
        xmlSerializer.endTag(null, Constants.EventInfoConsts.KEY_LX_INNER_DATAS_LIST);
    }
    ...
    public static final void a(byte[] bArr, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        ...
        xmlSerializer.attribute(null, RaptorConstants.JS_BATCH_NUM, Integer.toString(bArr.length));
    ...
    public static final void a(int[] iArr, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        ...
        xmlSerializer.attribute(null, RaptorConstants.JS_BATCH_NUM, Integer.toString(iArr.length));
        for (int i : iArr) {
    ...
    public static final void a(Object obj, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        ...
        if (obj == null) {
            ...
            if (obj instanceof Integer) {
                ...
                str2 = com.meituan.robust.Constants.LONG;
            } else if (obj instanceof Float) {
                str2 = "float";
            } else if (obj instanceof Double) {
                str2 = com.meituan.robust.Constants.DOUBLE;
                ...
                str2 = com.meituan.robust.Constants.BOOLEAN;
            }
    ...
    public static final HashMap m34a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m35a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
            int[] iArr = new int[Integer.parseInt(xmlPullParser.getAttributeValue(null, RaptorConstants.JS_BATCH_NUM))];
            int i = 0;
            int eventType = xmlPullParser.getEventType();
            do {
                if (eventType == 2) {
