...
public class AuthAgent extends BaseApi {
    ...
    public int doLogin(Activity activity, String str, IUiListener iUiListener, boolean z, Fragment fragment, boolean z2, Map<String, Object> map) {
        ...
        boolean a2 = f.a(activity.getIntent(), KEY_FORCE_QR_LOGIN, false);
        boolean b2 = g.a(activity, this.c.getAppId()).b("C_LoginWeb");
        SLog.i("openSDK_LOG.AuthAgent", "doLogin needForceQrLogin=" + a2 + ", toWebLogin=" + b2);
        if (!a2 && !b2 && a(activity, fragment, map, z, objArr)) {
    ...
    private int a(boolean z, IUiListener iUiListener, boolean z2, Map<String, Object> map) {
        CookieSyncManager.createInstance(com.tencent.open.utils.f.a());
        Bundle a2 = a();
        if (z) {
            a2.putString("isadd", "1");
        }
        a2.putString(Constants.PARAM_SCOPE, this.d);
        a2.putString(Constants.PARAM_CLIENT_ID, this.c.getAppId());
        if (isOEM) {
            a2.putString(Constants.PARAM_PLATFORM_ID, "desktop_m_qq-" + installChannel + "-android" + CommonConstant.Symbol.MINUS + registerChannel + CommonConstant.Symbol.MINUS + businessId);
        } else {
        ...
        a2.putString(DeviceInfo.SIGN, i.b(com.tencent.open.utils.f.a(), sb2));
        ...
        final String str = h.a().a(com.tencent.open.utils.f.a(), "https://openmobile.qq.com/oauth2.0/m_authorize?") + HttpUtils.encodeUrl(a2);
        final c cVar = new c(com.tencent.open.utils.f.a(), iUiListener, true, false);
                ...
                activity.runOnUiThread(new Runnable() { // from class: com.tencent.connect.auth.AuthAgent.1.1
                    ...
                    public void run() {
                        if (JniInterface.isJniOk) {
                            com.tencent.connect.auth.a aVar = new com.tencent.connect.auth.a(activity, "action_login", str, cVar, AuthAgent.this.c);
    ...
    private boolean a(Activity activity, Fragment fragment, Map<String, Object> map, boolean z, Object[] objArr) {
        ...
        if (b2 != null) {
            ...
            a(a2, map);
            a2.putString(Constants.KEY_APP_NAME, i.a(com.tencent.open.utils.f.a()));
    ...
    public void a(IUiListener iUiListener) {
        ...
        HttpUtils.requestAsync(this.c, com.tencent.open.utils.f.a(), "https://openmobile.qq.com/user/user_login_statis", a2, "POST", null);
    ...
    public void b(IUiListener iUiListener) {
        ...
        HttpUtils.requestAsync(this.c, com.tencent.open.utils.f.a(), "https://openmobile.qq.com/v3/user/get_info", a2, "GET", new BaseApi.TempRequestListener(new a(iUiListener)));
    }
        ...
        */
        public void onComplete(java.lang.Object r8) {
            ...
            L25:
                ...
                if (r3 != 0) goto L5f
                java.lang.ref.WeakReference<com.tencent.tauth.IUiListener> r0 = r7.a
        ...
        private Drawable a(String str, Context context) {
            ...
            try {
                ...
                if (str.endsWith(".9.png")) {
                    try {
                        bitmap = com.sankuai.waimai.launcher.util.image.a.a(open);
