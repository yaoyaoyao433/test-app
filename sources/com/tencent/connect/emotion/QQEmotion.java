...
public class QQEmotion extends BaseApi {
    ...
    public void setEmotions(Activity activity, ArrayList<Uri> arrayList, IUiListener iUiListener) {
        ...
        if (!i.b(activity)) {
            ...
            if (!TextUtils.isEmpty(a2)) {
                sb.append(a2);
                stringBuffer.append("&set_uri_list=" + Base64.encodeToString(k.j(a2), 2));
                stringBuffer.append("&ppsts");
                stringBuffer.append("=");
                stringBuffer.append(i.a(activity, sb.toString()));
    ...
    private boolean a(Context context, ArrayList<Uri> arrayList) {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            long a = k.a(context, arrayList.get(i));
            if (a > 1048576) {
    ...
    private String a(Activity activity, ArrayList<Uri> arrayList) {
        ...
        while (it.hasNext()) {
            Uri a = k.a(activity, this.c.getAppId(), k.b(activity, it.next()));
            if (a == null) {
