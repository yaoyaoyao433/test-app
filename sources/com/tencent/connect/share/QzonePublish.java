...
public class QzonePublish extends BaseApi {
    ...
    public void publishToQzone(final Activity activity, final Bundle bundle, final IUiListener iUiListener) {
        ...
        if (bundle == null) {
            ...
            e.a().a(1, "SHARE_CHECK_SDK", "1000", this.c.getAppId(), "4", Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "publicToQzone, this is not support below qq 5.9.5");
            ...
            if (i2 == 3) {
                ...
                e.a().a(1, "SHARE_CHECK_SDK", "1000", this.c.getAppId(), "4", Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "publishToQzone() 请选择支持的分享类型");
            }
        }
    }
