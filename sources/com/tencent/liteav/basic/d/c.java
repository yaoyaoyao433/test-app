...
public class c {
    ...
    private synchronized void o() {
        if (q()) {
            ...
            TXCLog.i("CloudConfig", "load config(system aec):" + this.j.e + CommonConstant.Symbol.COMMA + this.j.f + CommonConstant.Symbol.COMMA + this.j.h + CommonConstant.Symbol.COMMA + this.j.i + ", model = " + Build.MODEL + ", manufacturer = " + Build.MANUFACTURER + "， board = " + Build.BOARD);
        }
    }
