...
public class BaseWXApiImplV10 implements IWXAPI {
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        if (b.b(queryParameter)) {
            ...
            resp.scene = b.a(parse.getQueryParameter(KnbConstants.PARAMS_SCENE), 0);
    ...
    public boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        if (!WXApiImplComm.isIntentFromWx(intent, ConstantsAPI.Token.WX_TOKEN_VALUE_MSG)) {
            ...
            String a = f.a(intent, ConstantsAPI.CONTENT);
            int a2 = f.a(intent, ConstantsAPI.SDK_VERSION, 0);
            String a3 = f.a(intent, ConstantsAPI.APP_PACKAGE);
            if (a3 == null || a3.length() == 0) {
                Log.e(TAG, "invalid argument");
                return false;
            } else if (!checkSumConsistent(intent.getByteArrayExtra(ConstantsAPI.CHECK_SUM), a.a(a, a2, a3))) {
                Log.e(TAG, "checksum fail");
                return false;
            } else {
                int a4 = f.a(intent, "_wxapi_command_type", 0);
                Log.i(TAG, "handleIntent, cmd = " + a4);
                switch (a4) {
                    case 1:
    ...
    public boolean registerApp(String str, long j) {
        ...
        c1485a.a = "com.tencent.mm";
        c1485a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c1485a.c = "weixin://registerapp?appid=" + this.appId;
        c1485a.d = j;
        return a.a(this.context, c1485a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C1485a c1485a = new a.C1485a();
        c1485a.a = "com.tencent.mm";
        c1485a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c1485a.c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c1485a);
    }
}
