...
public class SocialOperation extends BaseApi {
    ...
    public void makeFriend(Activity activity, Bundle bundle) {
        ...
        if (!TextUtils.isEmpty(a)) {
            stringBuffer.append("&app_name=" + Base64.encodeToString(k.j(a), 2));
        }
        ...
        if (context == null) {
            ...
            DefaultUiListener defaultUiListener = new DefaultUiListener() { // from class: com.tencent.open.SocialOperation.1
                ...
                public void onComplete(Object obj) {
                    ...
                    if (obj == null) {
                        if (iUiListener != null) {
                            iUiListener.onError(new UiError(MapConstant.LayerPropertyFlag_MarkerSpacing, "服务端错误，请稍后重试", "资格检查回包为null。"));
                            return;
                        }
                        return;
                    }
    ...
    public void bindQQGroup(final Activity activity, String str, String str2, final IUiListener iUiListener) {
        ...
        if (TextUtils.isEmpty(a)) {
            ...
            stringBuffer.append("&appid=" + Base64.encodeToString(k.j(appId), 2));
            stringBuffer.append("&sdk_version=" + Base64.encodeToString(k.j(Constants.SDK_VERSION), 2));
            stringBuffer.append("&app_name_url_encode=" + k.f(Base64.encodeToString(k.j(a), 2)));
            stringBuffer.append("&organization_name_url_encode=" + k.f(Base64.encodeToString(k.j(str2), 2)));
