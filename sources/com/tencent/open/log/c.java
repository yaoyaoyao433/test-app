...
public class c {
    ...
    public static String d = "Tencent" + File.separator + "msflogs" + File.separator + "com" + File.separator + UserCenter.OAUTH_TYPE_QQ + File.separator + "mobileqq" + File.separator;
