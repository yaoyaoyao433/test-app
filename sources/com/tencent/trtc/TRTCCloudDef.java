...
public class TRTCCloudDef {
    ...
    public static class TRTCSpeedTestResult {
        ...
        public String toString() {
            return String.format("ip: %s, quality: %d, upLostRate: %.2f%%, downLostRate: %.2f%%, rtt: %d", this.ip, Integer.valueOf(this.quality), Float.valueOf(this.upLostRate * 100.0f), Float.valueOf(this.downLostRate * 100.0f), Integer.valueOf(this.rtt));
        }
    }
