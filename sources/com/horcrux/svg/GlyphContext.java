...
public class GlyphContext {
    ...
    public double nextDeltaX() {
        ...
        if (i < this.mDXs.length) {
            this.mDXIndex = i;
            this.mDX += PropHelper.fromRelative(this.mDXs[i], this.mWidth, 0.0d, this.mScale, this.mFontSize);
        }
        return this.mDX;
    }
    ...
    public double nextDeltaY() {
        ...
        if (i < this.mDYs.length) {
            this.mDYIndex = i;
            this.mDY += PropHelper.fromRelative(this.mDYs[i], this.mHeight, 0.0d, this.mScale, this.mFontSize);
        }
        return this.mDY;
    }
