...
public final class MRNModuleLoadingFailViewContainerManager extends MRNModuleViewContainerManager {
    ...
    /* compiled from: ProGuard */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lcom/dianping/gcmrnmodule/wrapperviews/containers/viewscontainer/MRNModuleLoadingFailViewContainerManager$Companion;", "", "()V", "NAME", "", "mrnmodule_release"}, k = 1, mv = {1, 1, 15})
    /* loaded from: classes.dex */
    ...
    public final k createViewInstance(@NotNull ao aoVar) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "9c7be854dbdba16c97682e6e6201b403", RobustBitConfig.DEFAULT_VALUE)) {
            return (k) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "9c7be854dbdba16c97682e6e6201b403");
        }
    ...
    public final void checkChildren(@NotNull k kVar, @Nullable View view, int i) {
        ...
        ChangeQuickRedirect changeQuickRedirect2 = changeQuickRedirect;
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "f5e759b59266f8c38c3380b668764588", RobustBitConfig.DEFAULT_VALUE)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "f5e759b59266f8c38c3380b668764588");
            return;
        }
        kotlin.jvm.internal.h.b(kVar, "parent");
        SoftAssertions.assertCondition(view instanceof com.dianping.gcmrnmodule.wrapperviews.items.viewitems.c, "MRNModule/MRNModulesVC/MRNModulesVCPage 的 loadingFailView 属性需要使用 MRNModuleView 标签");
    }
}
