...
public final class BaseModuleInfoDiff$diffChildren$2 extends i implements b<String, DynamicDiff<ViewInfo>> {
    public static ChangeQuickRedirect changeQuickRedirect;
    public final /* synthetic */ BaseModuleInfoDiff this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BaseModuleInfoDiff$diffChildren$2(BaseModuleInfoDiff baseModuleInfoDiff) {
        super(1);
    ...
    public final DynamicDiff<ViewInfo> invoke(@NotNull String str) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "56d2ad13df9a9d02fc5adab28fb6ec46", RobustBitConfig.DEFAULT_VALUE)) {
            return (DynamicDiff) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "56d2ad13df9a9d02fc5adab28fb6ec46");
        }
        h.b(str, "id");
        ViewItem viewItem = this.this$0.getDynamicModuleItem().failedViewItem;
        ...
        ViewItem viewItem2 = this.this$0.getDynamicModuleItem().failedViewItem;
        if (viewItem2 != null) {
