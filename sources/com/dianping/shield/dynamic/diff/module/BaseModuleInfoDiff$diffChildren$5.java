...
public final class BaseModuleInfoDiff$diffChildren$5 extends i implements b<String, DynamicDiff<ViewInfo>> {
    public static ChangeQuickRedirect changeQuickRedirect;
    public final /* synthetic */ BaseModuleInfoDiff this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BaseModuleInfoDiff$diffChildren$5(BaseModuleInfoDiff baseModuleInfoDiff) {
        super(1);
    ...
    public final DynamicDiff<ViewInfo> invoke(@NotNull String str) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "0cb7a602f9bb0413698b73cddb754003", RobustBitConfig.DEFAULT_VALUE)) {
            return (DynamicDiff) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "0cb7a602f9bb0413698b73cddb754003");
        }
        h.b(str, "id");
        ViewItem viewItem = this.this$0.getDynamicModuleItem().emptyViewItem;
        ...
        ViewItem viewItem2 = this.this$0.getDynamicModuleItem().emptyViewItem;
        if (viewItem2 != null) {
