...
public final class BaseModuleInfoDiff$diffChildren$1 extends i implements b<String, DynamicDiff<ViewInfo>> {
    public static ChangeQuickRedirect changeQuickRedirect;
    public final /* synthetic */ BaseModuleInfoDiff this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BaseModuleInfoDiff$diffChildren$1(BaseModuleInfoDiff baseModuleInfoDiff) {
        super(1);
    ...
    public final DynamicDiff<ViewInfo> invoke(@NotNull String str) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "847aed6766f1aa7d459ca3a5413707f3", RobustBitConfig.DEFAULT_VALUE)) {
            return (DynamicDiff) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "847aed6766f1aa7d459ca3a5413707f3");
        }
        h.b(str, "id");
        ViewItem viewItem = this.this$0.getDynamicModuleItem().loadingViewItem;
        ...
        ViewItem viewItem2 = this.this$0.getDynamicModuleItem().loadingViewItem;
        if (viewItem2 != null) {
