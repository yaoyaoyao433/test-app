...
public final class BaseTabModuleInfoDiff$diffChildren$5 extends g implements b<ExtraViewInfo, DynamicViewItem<ExtraViewInfo>> {
    ...
    public final d getOwner() {
        ...
        return PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "b7a75032285a9e4db60a40a244f160a2", RobustBitConfig.DEFAULT_VALUE) ? (d) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "b7a75032285a9e4db60a40a244f160a2") : u.a(BaseTabModuleInfoDiff.class);
    }
    ...
    public final DynamicViewItem<ExtraViewInfo> invoke(@NotNull ExtraViewInfo extraViewInfo) {
        ...
        ChangeQuickRedirect changeQuickRedirect2 = changeQuickRedirect;
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "088b1bf8e58790870fb21654ff255cfe", RobustBitConfig.DEFAULT_VALUE)) {
            return (DynamicViewItem) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "088b1bf8e58790870fb21654ff255cfe");
        }
