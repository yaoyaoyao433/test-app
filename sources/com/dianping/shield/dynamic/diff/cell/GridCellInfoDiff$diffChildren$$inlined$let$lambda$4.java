...
public final class GridCellInfoDiff$diffChildren$$inlined$let$lambda$4 extends i implements b<ExtraViewInfo, DynamicViewItem<ExtraViewInfo>> {
    ...
    public GridCellInfoDiff$diffChildren$$inlined$let$lambda$4(GridCellInfoDiff gridCellInfoDiff, GridRowItem gridRowItem) {
        super(1);
    ...
    public final DynamicViewItem<ExtraViewInfo> invoke(@NotNull ExtraViewInfo extraViewInfo) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "bb54bbe575ff8c927356465f63c0dac2", RobustBitConfig.DEFAULT_VALUE)) {
