...
public final class TabCellInfoDiff$diffChildren$1$1 extends g implements b<ExtraViewInfo, DynamicViewItem<ExtraViewInfo>> {
    public static ChangeQuickRedirect changeQuickRedirect;

    public TabCellInfoDiff$diffChildren$1$1(TabCellInfoDiff tabCellInfoDiff) {
    ...
    public final d getOwner() {
        ...
        return PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "33f0dbba20e4f1ec74473bdd9d7bdf76", RobustBitConfig.DEFAULT_VALUE) ? (d) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "33f0dbba20e4f1ec74473bdd9d7bdf76") : u.a(TabCellInfoDiff.class);
    }
    ...
    public final DynamicViewItem<ExtraViewInfo> invoke(@NotNull ExtraViewInfo extraViewInfo) {
        ...
        ChangeQuickRedirect changeQuickRedirect2 = changeQuickRedirect;
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "057bb873ae61680339798f009a20a3a5", RobustBitConfig.DEFAULT_VALUE)) {
            return (DynamicViewItem) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "057bb873ae61680339798f009a20a3a5");
        }
