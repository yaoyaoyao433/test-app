...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J(\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\nH\u0016¨\u0006\f"}, d2 = {"Lcom/dianping/shield/node/processor/legacy/row/HeaderSetTopInterfaceProcessor;", "Lcom/dianping/shield/node/processor/legacy/row/RowInterfaceProcessor;", "()V", "handleRowItem", "", "sci", "Lcom/dianping/agentsdk/framework/SectionCellInterface;", "rowItem", "Lcom/dianping/shield/node/useritem/RowItem;", "section", "", "row", "shieldCore_release"}, k = 1, mv = {1, 1, 13})
...
public final class HeaderSetTopInterfaceProcessor extends RowInterfaceProcessor {
    ...
    public final boolean handleRowItem(@NotNull af afVar, @NotNull RowItem rowItem, int i, int i2) {
        i headerSetTopParams;
        Object[] objArr = {afVar, rowItem, Integer.valueOf(i), Integer.valueOf(i2)};
        ChangeQuickRedirect changeQuickRedirect2 = changeQuickRedirect;
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "ec8dc5d2f560e4abfcc0b507aa8f6d2f", RobustBitConfig.DEFAULT_VALUE)) {
            return ((Boolean) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "ec8dc5d2f560e4abfcc0b507aa8f6d2f")).booleanValue();
        }
        h.b(afVar, "sci");
        h.b(rowItem, "rowItem");
        if (afVar instanceof ai) {
            if (afVar instanceof TopPositionInterface) {
                TopPositionInterface.TopPositionInfo topPositionInfo = ((TopPositionInterface) afVar).getTopPositionInfo(CellType.HEADER, i, i2);
                ...
                int headerViewType = ((ai) afVar).getHeaderViewType(i);
                ...
                if (extraCellTopParamsInterface.isHeaderTopView(headerViewType)) {
                    ...
                    if (topInfo != null && (headerSetTopParams = extraCellTopParamsInterface.getHeaderSetTopParams(headerViewType)) != null) {
                        topInfo.offset = headerSetTopParams.a;
                    }
                }
            } else if ((afVar instanceof ExtraCellTopInterface) && ((ExtraCellTopInterface) afVar).isHeaderTopView(((ai) afVar).getHeaderViewType(i))) {
                rowItem.topInfo = TopInfoHelper.Companion.createTopInfo();
            }
        }
        return false;
