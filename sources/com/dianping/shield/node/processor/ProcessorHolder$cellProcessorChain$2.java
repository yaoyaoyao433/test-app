...
public final class ProcessorHolder$cellProcessorChain$2 extends i implements a<ProcessorChain> {
    public static ChangeQuickRedirect changeQuickRedirect;
    public final /* synthetic */ ProcessorHolder this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ProcessorHolder$cellProcessorChain$2(ProcessorHolder processorHolder) {
        super(0);
    ...
    public final ProcessorChain invoke() {
        ...
        return PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "c1e8994449175b6271a26b21d08ca54e", RobustBitConfig.DEFAULT_VALUE) ? (ProcessorChain) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "c1e8994449175b6271a26b21d08ca54e") : new ProcessorChain(this.this$0).addProcessor(CellExtraInfosNodeProcessor.class).addProcessor(CellStatusNodeProcessor.class).addProcessor(NormalCellNodeProcessor.class).addProcessor(CellStatusMoreNodeProcessor.class).addProcessor(CellNodeExposeProcessor.class).addProcessor(CellMoveStatusNodeProcessor.class).addProcessor(CellNodeMappingProcessor.class);
    }
}
