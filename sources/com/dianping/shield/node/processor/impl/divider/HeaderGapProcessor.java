...
public final class HeaderGapProcessor extends DividerInfoProcessor {
    ...
    public HeaderGapProcessor(@NotNull Context context, @NotNull DividerThemePackage dividerThemePackage) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "49aa66004b7ac3a0fbfb106db23d93ba", 6917529027641081856L)) {
    ...
    public final boolean handleDividerInfo(@NotNull ShieldDisplayNode shieldDisplayNode) {
        ...
        ChangeQuickRedirect changeQuickRedirect2 = changeQuickRedirect;
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "253b71a556f23d77da2a1078cd49178e", RobustBitConfig.DEFAULT_VALUE)) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[shieldDisplayNode.getPositionType().ordinal()]) {
            ...
            case 2:
                ...
                int i = -1;
                int i2 = (shieldRow == null || (shieldSection4 = shieldRow.sectionParent) == null) ? -1 : shieldSection4.sectionHeaderHeight;
                ...
                if (shieldRow3 == null || (shieldSection2 = shieldRow3.sectionParent) == null || (drawable2 = shieldSection2.sectionHeaderDrawable) == null) {
                    ShieldRow shieldRow4 = shieldDisplayNode.rowParent;
                    if (shieldRow4 != null && (shieldSection = shieldRow4.sectionParent) != null && (shieldViewCell = shieldSection.cellParent) != null && (drawable = shieldViewCell.sectionHeaderDrawable) != null) {
                        DividerConfigInfo dividerConfigInfo4 = shieldDisplayNode.dividerInfo;
                        if (dividerConfigInfo4 != null) {
                            dividerConfigInfo4.headerGapDrawable = drawable;
                        }
                        rVar2 = r.a;
                    }
                } else {
                    ...
                    if (dividerConfigInfo5 != null) {
                        dividerConfigInfo5.headerGapDrawable = drawable2;
                    }
                    rVar2 = r.a;
                }
                if (rVar2 == null) {
                    if (this.dividerThemePackage.defaultHeaderDrawable != null) {
                        DividerConfigInfo dividerConfigInfo6 = shieldDisplayNode.dividerInfo;
                        if (dividerConfigInfo6 != null) {
                            dividerConfigInfo6.headerGapDrawable = this.dividerThemePackage.defaultHeaderDrawable;
                        }
                    } else {
                        DividerConfigInfo dividerConfigInfo7 = shieldDisplayNode.dividerInfo;
                        if (dividerConfigInfo7 != null) {
                            dividerConfigInfo7.headerGapDrawable = this.dividerThemePackage.defaultSpaceDrawable;
                        }
                    }
                    r rVar3 = r.a;
                    break;
            ...
            case 4:
                ...
                if (dividerConfigInfo9 != null) {
                    dividerConfigInfo9.headerGapDrawable = null;
                    break;
                }
                break;
        }
