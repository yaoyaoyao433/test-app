...
public final class SectionExtraInfosNodeProcessor extends SectionNodeProcessor {
    ...
    public final boolean handleShieldSection(@NotNull SectionItem sectionItem, @NotNull ShieldSection shieldSection) {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "af9963591707880d5cfe5e56ad74cdc5", RobustBitConfig.DEFAULT_VALUE)) {
            return ((Boolean) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "af9963591707880d5cfe5e56ad74cdc5")).booleanValue();
        }
