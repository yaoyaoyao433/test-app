...
public final class ProcessorHolder$nodeProcessorChain$2 extends i implements a<ProcessorChain> {
    public static ChangeQuickRedirect changeQuickRedirect;
    public final /* synthetic */ ProcessorHolder this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ProcessorHolder$nodeProcessorChain$2(ProcessorHolder processorHolder) {
        super(0);
    ...
    public final ProcessorChain invoke() {
        ...
        return PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "c4084ba8f8682ae6c06b05da3971fd5c", RobustBitConfig.DEFAULT_VALUE) ? (ProcessorChain) PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "c4084ba8f8682ae6c06b05da3971fd5c") : new ProcessorChain(this.this$0).addProcessor(BaseDisplayNodeProcessor.class).addProcessor(ClickDisplayNodeProcessor.class).addProcessor(DisplayNodeExposeProcessor.class).addProcessor(DisplayNodeHotZoneProcessor.class).addProcessor(DisplayNodeRowAppearanceProcessor.class);
    }
}
