...
public class BaseScrollableRowItem extends CommonContainerRowItem {
    ...
    public void clear() {
        ...
        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect2, false, "4b3bd3cd3bf2a559f576c6df1f45ba22", RobustBitConfig.DEFAULT_VALUE)) {
            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect2, false, "4b3bd3cd3bf2a559f576c6df1f45ba22");
            return;
        }
        super.clear();
