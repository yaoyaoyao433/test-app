...
public class PlatformMessageSender {
    ...
    public static void launchStartActivity(Context context, String str, String str2, String str3) {
        ...
        MessageV3 parse = MessageV3.parse(str, str, a2.c, a2.d, a2.a, a2.b, str2);
        Intent intent = new Intent();
    ...
    public static void showQuickNotification(Context context, String str, String str2) {
        ...
        Intent intent = new Intent();
        intent.putExtra(PushConstants.EXTRA_APP_PUSH_SEQ_ID, a2.b);
        intent.putExtra(PushConstants.EXTRA_APP_PUSH_TASK_ID, a2.a);
        ...
        intent.putExtra(PushConstants.MZ_PUSH_MESSAGE_STATISTICS_IMEI_KEY, a2.d);
